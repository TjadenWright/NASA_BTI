...
IP = "192.168.166.148"  # Camera IP address
PORT = 80  # Port
USER = "admin"  # Username
PASS = "nasabs123"  # Password
...
frame_container1.pack(side=TOP, fill=BOTH, padx=10, pady=10)

# move camera left and right
button1 = Button(frame_container1, text="<", bg="#FFD100", fg="black")
button1.pack(side=LEFT)
button1.bind("<ButtonPress>", lambda event: left())
button1.bind("<ButtonRelease>", lambda event: stop())
button2 = Button(frame_container1, text=">", bg="#FFD100", fg="black")
button2.pack(side=RIGHT)
button2.bind("<ButtonPress>", lambda event: right())
button2.bind("<ButtonRelease>", lambda event: stop())
button3 = Button(frame_container1, text="^", bg="#FFD100", fg="black")
button3.pack(side=TOP)
button3.bind("<ButtonPress>", lambda event: up())
button3.bind("<ButtonRelease>", lambda event: stop())
button4 = Button(frame_container1, text="v", bg="#FFD100", fg="black")
