...
class GUI:
    ...
    def handle_selection_man_or_auto(self, event):
            ...
            if(selected_item == 0): # manual mode
                options2 = ["Individual Control", "Forward Drive Mode", "Reverse Drive Mode", "Tank Steer Mode", "Excavate Mode", "Excavate Test Mode", "Docking Mode (Excavator)", "Docking Mode (Dumptruck)"]
