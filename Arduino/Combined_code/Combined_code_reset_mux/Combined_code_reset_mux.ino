...
#if testbench == true
  #define lower_GPIO 0x20
  #define upper_GPIO 0x21
#else
  #define lower_GPIO 0x38
  #define upper_GPIO 0x39
#endif
...
// H-bridge //
//////////////
VNH7070 vnh(lower_GPIO);

/////////////
// I2C ADC //
/////////////
ADS1219 ads(P4, lower_GPIO);
ADS1219 ads_mother(P3, lower_GPIO);
...
void setup() {
  ...
  for (uint8_t i = 0; i < max_channels; i++) {
    ...
    if (i != max_channels - 1 || Arduino_or_latte) {  // motor/actuator
      ...
      ads_mother.setConversionMode(CONTINUOUS);

      ads_mother.readSingleEnded(3, 1);  // start the conversion of 3 since it will always convert (never need to change)
    }
